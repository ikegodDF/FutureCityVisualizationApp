...
} from "../../editor/modal/modalRoot.js";
...
export const openRangeOrderModal = ({ currentYear }) =>
  new Promise((resolve) => {
    let settled = false;
    ...
    row.appendChild(createOptionButton(1, "1: 都市機能誘導"));
    row.appendChild(createOptionButton(2, "2: 建物の新築化"));
